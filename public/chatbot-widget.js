(function() {
  ...
  iframe.style.cssText = 'position: fixed; bottom: 24px; right: 24px; width: 88px; height: 88px; border: none; z-index: 2147483647; background: transparent; pointer-events: auto; display: block; transition: all 0.3s ease-in-out; overflow: visible;';
