...
(function() {
  ...
  console.log('[VBH Widget] Initializing...');
  ...
  function createWidget() {
    ...
    console.log('[VBH Widget] Widget iframe created, src:', iframe.src);
  ...
  function setupMessageListener(container) {
    window.addEventListener('message', function(event) {
      ...
      if (data.type === 'vbh-widget-resize') {
        ...
        console.log('[VBH Widget] Resize:', data.expanded ? 'expanded' : 'collapsed');
      }
    });
  }
  ...
  function init() {
    if (document.body) {
      ...
      console.log('[VBH Widget] Initialized successfully');
    } else {
